...
let MessagesService = class MessagesService {
    ...
    sendnextmessage(parentId, nodeId) {
        var array = [];
    ...
    editobjective(messageindex, dataindex, type) {
        if (type == 'minus') {
...
//# sourceMappingURL=default~pages-map-map-module~pages-message-center-message-center-module~pages-tabs-page-tabs-page-module-es2015.js.map