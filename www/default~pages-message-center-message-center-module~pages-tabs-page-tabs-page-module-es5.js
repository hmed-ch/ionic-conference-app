...
var CharsComponent = /** @class */ (function () {
    function CharsComponent() {
        var _this = this;
                ...
                datalabels: {
                    formatter: function (value, ctx) {
                        if (ctx.chart.config.type == 'bar') {
                            if (_this.indexdata >= ctx.chart.data.datasets.length)
                                _this.indexdata = 0;
                            var label = ctx.chart.data.datasets[_this.indexdata].label;
                            _this.indexdata += 1;
                            return label;
                        }
                        else {
    ...
    CharsComponent.prototype.chartClicked = function (e) {
        console.log(e);
    };
    CharsComponent.prototype.chartHovered = function (e) {
    };
    CharsComponent.prototype.ngOnInit = function () {
...
var MessageCenterPage = /** @class */ (function () {
    function MessageCenterPage(modalController, Message, router, location) {
    ...
    MessageCenterPage.prototype.ngOnInit = function () {
    ...
    MessageCenterPage.prototype.ionViewDidEnter = function () {
    };
    MessageCenterPage.prototype.onButtonClick = function (parentId, optionId, buttype, buttext) {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(buttype == 'simulation')) return [3 /*break*/, 3];
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss().then(function (result) {
                            if (result !== null) {
                                _this.Message.setsimulationresult(result.data);
                                console.log(parentId, optionId, result.data);
                                _this.Message.sendnextmessage(parentId, optionId);
    ...
    MessageCenterPage.prototype.onReplyClick = function (parentId, optionId, optText) {
        this.Message.quickReplyshown();
        this.Message.addMessage({ text: optText, sender: 'user' });
        this.Message.sendnextmessage(parentId, optionId);
        this.scrollToBottom();
    };
    MessageCenterPage.prototype.senduserinput = function (parentId, optText) {
        this.Message.quickReplyshown();
        this.Message.addMessage({ text: optText, sender: 'user' });
        this.Message.sendnextmessage(parentId, 0);
        this.scrollToBottom();
    };
    MessageCenterPage.prototype.sendMessage = function (event) {
        this.msg = '';
        this.Message.addMessage({ text: event, sender: 'user' });
        this.Message.sendinputnext();
        this.scrollToBottom();
    };
    MessageCenterPage.prototype.scrollToBottom = function () {
        var _this = this;
        try {
            setTimeout(function () {
    ...
    MessageCenterPage.prototype.myBackButton = function () {
        this.location.back();
    };
    MessageCenterPage.prototype.minus = function (msgindex, dataindex) {
        this.Message.editobjective(msgindex, dataindex, 'munis');
    };
    MessageCenterPage.prototype.plus = function (msgindex, dataindex) {
        this.Message.editobjective(msgindex, dataindex, 'plus');
    };
    MessageCenterPage.ctorParameters = function () { return [
...
var SimulatorPage = /** @class */ (function () {
    function SimulatorPage(modalController, navParams, sanitizer) {
        this.modalController = modalController;
    ...
    SimulatorPage.prototype.ngOnInit = function () {
        this.url = this.sanitizer.bypassSecurityTrustResourceUrl(this.weburl);
        var acmodal = this.modalController;
        var payload = this.successpayload;
        var onClosedData = "Wrapped Up!";
    ...
    SimulatorPage.prototype.closeModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var onClosedData;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    SimulatorPage.prototype.validate = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    SimulatorPage.prototype.operation = function (_a) {
        var amount = _a.amount, loanTerm = _a.loanTerm;
        var principal = parseFloat(amount);
        var interest = (2 / 100) / 12;
        var payments = parseFloat(loanTerm);
        // compute the monthly payment figure
        var x = Math.pow(1 + interest, payments);
        var monthly = (principal * x * interest) / (x - 1);
        return Math.round(monthly * 100) / 100;
    };
    SimulatorPage.prototype.ngOnDestroy = function () {
        // this.formChangesSubscription.unsubscribe();
    };
    SimulatorPage.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] },
...
//# sourceMappingURL=default~pages-message-center-message-center-module~pages-tabs-page-tabs-page-module-es5.js.map