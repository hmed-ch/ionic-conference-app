...
var BankmodalComponent = /** @class */ (function () {
    function BankmodalComponent(modalController, confData) {
        this.modalController = modalController;
        this.confData = confData;
        this.popularbanks = [];
        this.defaultHref = '';
    }
    BankmodalComponent.prototype.ngOnInit = function () {
        ...
        var restbank = popbanks.slice(i);
        if (restbank.lenght % 2 != 0)
            restbank.push({ bank_id: null });
        this.popularbanks.push(restbank);
    };
    BankmodalComponent.prototype.addFavorite = function (bank) {
        console.log(bank);
    };
    BankmodalComponent.prototype.closeModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var onClosedData;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    BankmodalComponent.ctorParameters = function () { return [
...
var SchedulePage = /** @class */ (function () {
    function SchedulePage(alertCtrl, confData, loadingCtrl, router, toastCtrl, user, config, modalController) {
        var _this = this;
        ...
        confData.getchangement().subscribe(function (data) {
            console.log('hi');
    ...
    SchedulePage.prototype.ionViewDidEnter = function () {
        ...
        this.totalbalance = 0;
        for (var i = 0; i < this.dictkeys.length; i++) {
            for (var j = 0; j < this.data['comptes'][this.dictkeys[i]].length; j++) {
    ...
    SchedulePage.prototype.getgraph = function (testSlider) {
        var _this = this;
        testSlider.getActiveIndex().then(function (index) {
            _this.graphdata = index;
            console.log(_this.graphdata);
        });
        ;
    };
    SchedulePage.prototype.nex = function () {
        this.slides.slideNext();
    };
    SchedulePage.prototype.prev = function () {
...
var SessionDetailPage = /** @class */ (function () {
    function SessionDetailPage(dataProvider, userProvider, route, location) {
    ...
    SessionDetailPage.prototype.myBackButton = function () {
        this.location.back();
    };
