(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pages-map-map-module~pages-message-center-message-center-module~pages-tabs-page-tabs-page-module"],{
...
var MessagesService = /** @class */ (function () {
    ...
    MessagesService.prototype.sendnextmessage = function (parentId, nodeId) {
        var _this = this;
        var array = [];
        array = this.currentScript.questions;
        var currentquestion = array.find(function (script) { return script['id'] == parentId; });
        if (currentquestion.next_node) {
            var nextquestion_1 = JSON.parse(JSON.stringify(array.find(function (script) { return script['id'] == currentquestion.next_node[nodeId.toString()]; })));
            nextquestion_1.display = true;
            if (nextquestion_1.id == 25) {
                nextquestion_1.text = "La simulation indique que vous gagnez " + this.simresult.savings + " Tnd après " + this.simresult.yearsToSave + " ans.";
            }
            if (nextquestion_1.id == 23) {
                var amount = parseInt(this.messages[this.messages.length - 1].text) * 93.84 + 101430;
                nextquestion_1.text = "Si vous continuez à épargner de la même manière, vous aurez " + amount + " Tnd après 23 ans.\nPensez vous disposer à la retraite de :";
            }
            this.messages.push(nextquestion_1);
            if (nextquestion_1.redirection) {
                setTimeout(function () {
                    _this.sendnextmessage(nextquestion_1['id'], 0);
                }, 1000);
            }
        }
    };
    MessagesService.prototype.sendinputnext = function () {
        var lastmessagesend = this.messages[this.messages.length - 2];
        var array = [];
        array = this.currentScript.questions;
        if (lastmessagesend.next_node) {
            var nextquestion = array.find(function (script) { return (script['id'] == lastmessagesend.next_node['0']); });
            ...
            if (nextquestion.id == 23) {
                var amount = parseInt(this.messages[this.messages.length - 1].text) * 23;
    ...
    MessagesService.prototype.setsimulationresult = function (result) {
        this.simresult = result;
    };
    MessagesService.prototype.getMessages = function (contactId) {
        return this.messages;
    };
    MessagesService.prototype.addMessage = function (msg) {
        this.messages.push(msg);
    };
    MessagesService.prototype.quickReplyshown = function () {
        this.messages[this.messages.length - 1].selected = true;
    };
    MessagesService.prototype.clearHistory = function () {
        this.messages = [];
    };
    MessagesService.prototype.getlength = function () {
        return this.messages.length;
    };
    MessagesService.prototype.editobjective = function (messageindex, dataindex, type) {
        if (type == 'minus') {
...
//# sourceMappingURL=default~pages-map-map-module~pages-message-center-message-center-module~pages-tabs-page-tabs-page-module-es5.js.map